...
export function ChatSidebar({
  ...
  return (
    ...
    >
      ...
      <Box
        style={
          chatSidebarStyles.messagesContainer
        }
      >
        <ScrollArea
          style={
            chatSidebarStyles.scrollArea
          }
          scrollbars="vertical"
        >
          <Box
                          ...
                          "text" ? (
                            isUser ? (
                              <Text
                                ...
                                size="2"
                                style={
                                  chatSidebarStyles.messageTextTeal
                                }
                              >
                                {
                                  part.text
